...
import currentLocationIcon from './../assets/images/bike.png'; 
...
const DriverMap = () => {
    ...
    const handleConfirm = async () => {
        try {
            // await axios.delete(`http://192.168.58.127:4000/api/packages/${packageDetails.id}`);
            Alert.alert(
                'Finish the ride?',
                'Nice work, Choose another Package.',
                [
                    { text: 'OK', onPress: () => navigation.navigate('Driver') }
                ]
            );
        } catch (error) {
            Alert.alert('Error', `Unable to delete the package: ${error.message}`);
        }
    };
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <Button title="Finish the Ride" onPress={handleConfirm} />
            </View>
        </View>
    );
};
...
//             );
//         } catch (error) {
//             Alert.alert('Error', 'Unable to delete the package');
//         }
//     };
